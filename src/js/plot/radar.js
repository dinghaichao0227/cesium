...
export const radar = (x, y, viewer) => {
  console.log(x, y, 324243);
  // var lat = 48.06846397543379;// 42.006;
  // var lon = -87.009098292633176;//128.055;
  var lat = x; // 42.006;
  var lon = y; //128.055;
  ...
  var tileset = new Cesium.Cesium3DTileset({ url: Cesium.IonResource.fromAssetId(574100000) });
  ...
  */
  function AddRadarScanPostStage(viewer, cartographicCenter, radius, scanColor, duration) {
    ...
    var _CartographicCenter1 = new Cesium.Cartographic(cartographicCenter.longitude, cartographicCenter.latitude, cartographicCenter.height + 5000);
    var _Cartesian3Center1 = Cesium.Cartographic.toCartesian(_CartographicCenter1);
    var _Cartesian4Center1 = new Cesium.Cartesian4(_Cartesian3Center1.x, _Cartesian3Center1.y, _Cartesian3Center1.z, 10);
  ...
  var CartographicCenter = new Cesium.Cartographic(Cesium.Math.toRadians(lon), Cesium.Math.toRadians(lat), 1);
  var scanColor = new Cesium.Color(1.0, 0.0, 0.0, 1);
AddRadarScanPostStage(viewer, CartographicCenter, 300000, scanColor, 4000);
  var isAdd = false;
  // setvisible = (value) =>{
  //   switch (value) {
  //     case 'position':
